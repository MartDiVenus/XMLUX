...
do
	...
	then
		...
		cp /tmp/xmluxv-cssRoot/$c /tmp/xmluxv-parts
...
cp /tmp/xmluxv-cssRoot/$c /tmp/xmluxv-chapters
...
cp /tmp/xmluxv-css05Split/$d /tmp/xmluxv-sections
...
cp /tmp/xmluxv-css05Split/$d /tmp/xmluxv-subsections
...
mkdir /tmp/xmluxv-subsubsections
...
cp /tmp/xmluxv-css05Split/$d /tmp/xmluxv-subsubsections
...
cp /tmp/xmluxv-css05Split/$d /tmp/xmluxv-paragraphs
...
################ INIZIO SUBPARAGRAPH
mkdir /tmp/xmluxv-subparagraphs
...
cp /tmp/xmluxv-css05Split/$d /tmp/xmluxv-subparagraphs
