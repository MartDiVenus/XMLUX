...
do
	...
	then
		...
		cp /tmp/xmluxv-cssRoot/$c /tmp/xmluxv-section
...
cp /tmp/xmluxv-cssRoot/$c /tmp/xmluxv-subsection
...
mkdir /tmp/xmluxv-subsubsection
...
cp /tmp/xmluxv-css05Split/$d /tmp/xmluxv-subsubsection
...
cp /tmp/xmluxv-css05Split/$d /tmp/xmluxv-paragraph
...
cp /tmp/xmluxv-css05Split/$d /tmp/xmluxv-subparagraph
...
cp /tmp/xmluxv-css05Split/$d /tmp/xmluxv-saxum
...
cp /tmp/xmluxv-css05Split/$d /tmp/xmluxv-subsaxum
