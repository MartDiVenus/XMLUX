...
/usr/local/lib/xmlux/xmluxeScripts/move/brief/book/moveSilent.sh

else

/usr/local/lib/xmlux/xmluxeScripts/move/brief/book/moveVerbose.sh
...
/usr/local/lib/xmlux/xmluxeScripts/add/brief/brief-book-add.sh
...
/usr/local/lib/xmlux/xmluxeScripts/remove/brief/brief-book/remove.sh
...
then
	...
	touch /tmp/xmluxe-cimiceBrief-book
...
/usr/local/lib/xmlux/xmluxeScripts/jump/brief/brief-book/jump.sh
...
/usr/local/lib/xmlux/xmluxeScripts/select/selectR/brief/brief-book/selectR.sh
...
/usr/local/lib/xmlux/xmluxeScripts/select/selectW/brief/brief-book/selectW.sh
...
/usr/local/lib/xmlux/xmluxeScripts/render/brief/brief-book/render.sh
