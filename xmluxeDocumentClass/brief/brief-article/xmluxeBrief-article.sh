...
/usr/local/lib/xmlux/xmluxeScripts/move/brief/article/moveSilent.sh

else

/usr/local/lib/xmlux/xmluxeScripts/move/brief/article/moveVerbose.sh
...
/usr/local/lib/xmlux/xmluxeScripts/add/brief/brief-article-add.sh
...
/usr/local/lib/xmlux/xmluxeScripts/remove/brief/brief-article/remove.sh
...
then
	...
	touch /tmp/xmluxe-cimiceBrief-article
...
/usr/local/lib/xmlux/xmluxeScripts/jump/brief/brief-article/jump.sh
...
/usr/local/lib/xmlux/xmluxeScripts/select/selectR/brief/brief-article/selectR.sh
...
/usr/local/lib/xmlux/xmluxeScripts/select/selectW/brief/brief-article/selectW.sh
...
then
	...
	/usr/local/lib/xmlux/xmluxeScripts/render/brief/brief-article/render.sh
...
then
	...
	/usr/local/lib/xmlux/xmluxeScripts/lack/brief/brief-article-lack.sh
