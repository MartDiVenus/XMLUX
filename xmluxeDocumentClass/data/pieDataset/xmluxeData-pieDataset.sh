...
then
	...
	touch /tmp/xmluxe-cimicePieDataset
...
/usr/local/lib/xmlux/xmluxeScripts/move/data/pieDataset/moveSilent.sh

else

/usr/local/lib/xmlux/xmluxeScripts/move/data/pieDataset/moveVerbose.sh
...
/usr/local/lib/xmlux/xmluxeScripts/add/data/pieDataset-add.sh
...
/usr/local/lib/xmlux/xmluxeScripts/remove/data/pieDataset/remove.sh
...
/usr/local/lib/xmlux/xmluxeScripts/jump/data/pieDataset/jump.sh
...
/usr/local/lib/xmlux/xmluxeScripts/select/selectR/data/pieDataset/selectR.sh
...
/usr/local/lib/xmlux/xmluxeScripts/select/selectW/data/pieDataset/selectW.sh
...
/usr/local/lib/xmlux/xmluxeScripts/render/data/pie-dataset/render.sh
...
then
	...
	/usr/local/lib/xmlux/xmluxeScripts/lack/data/pieDataset/pieDataset-lack.sh
