...
then
	...
	touch /tmp/xmluxe-cimiceCategoryDataset01
...
/usr/local/lib/xmlux/xmluxeScripts/move/data/categoryDataset/categoryDataset01/moveSilent.sh

else

/usr/local/lib/xmlux/xmluxeScripts/move/data/categoryDataset/categoryDataset01/moveVerbose.sh
...
/usr/local/lib/xmlux/xmluxeScripts/add/data/categoryDataset/categoryDataset01-add.sh
...
/usr/local/lib/xmlux/xmluxeScripts/remove/data/categoryDataset/categoryDataset01/remove.sh
...
/usr/local/lib/xmlux/xmluxeScripts/jump/data/categoryDataset/categoryDataset01/jump.sh
...
/usr/local/lib/xmlux/xmluxeScripts/select/selectR/data/categoryDataset/categoryDataset01/selectR.sh
...
/usr/local/lib/xmlux/xmluxeScripts/select/selectW/data/categoryDataset/categoryDataset01/selectW.sh
...
/usr/local/lib/xmlux/xmluxeScripts/render/data/categoryDataset/categoryDataset01/render.sh
...
then
	...
	/usr/local/lib/xmlux/xmluxeScripts/lack/data/categoryDataset/categoryDataset01-lack.sh
