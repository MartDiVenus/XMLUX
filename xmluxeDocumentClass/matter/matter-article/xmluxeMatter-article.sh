...
/usr/local/lib/xmlux/xmluxeScripts/move/matter/article/moveSilent.sh

else

/usr/local/lib/xmlux/xmluxeScripts/move/matter/article/moveVerbose.sh
...
/usr/local/lib/xmlux/xmluxeScripts/add/matter/matter-article-add.sh
...
/usr/local/lib/xmlux/xmluxeScripts/remove/matter/matter-article/remove.sh
...
then
	...
	touch /tmp/xmluxe-cimiceMatter-article
...
/usr/local/lib/xmlux/xmluxeScripts/jump/matter/matter-article/jump.sh
...
/usr/local/lib/xmlux/xmluxeScripts/select/selectR/matter/matter-article/selectR.sh
...
/usr/local/lib/xmlux/xmluxeScripts/select/selectW/matter/matter-article/selectW.sh
...
then
	...
	/usr/local/lib/xmlux/xmluxeScripts/parse/matter/matter-article/parse.sh
...
/usr/local/lib/xmlux/xmluxeScripts/render/matter/matter-article/render.sh
...
then
	...
	/usr/local/lib/xmlux/xmluxeScripts/lack/matter/matter-article-lack.sh
