...
/usr/local/lib/xmlux/xmluxeScripts/remove/matter/matter-book/remove.sh
...
/usr/local/lib/xmlux/xmluxeScripts/jump/matter/matter-book/jump.sh
...
/usr/local/lib/xmlux/xmluxeScripts/select/selectR/matter/matter-book/selectR.sh
...
/usr/local/lib/xmlux/xmluxeScripts/select/selectW/matter/matter-book/selectW.sh
...
/usr/local/lib/xmlux/xmluxeScripts/parse/matter/matter-book/parse.sh
...
/usr/local/lib/xmlux/xmluxeScripts/render/matter/matter-book/render.sh
