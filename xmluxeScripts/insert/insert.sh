...
<Key ID=\"$newID.01\" name=\"KEY $newID.01\">$key
</Key>
<!-- end $newID.01 -->

<Value ID=\"$newID.02\" name=\"VALUE $newID.02\">$value
</Value>
<!-- end $newID.02 -->
...
<Key ID=\"$newID.01\" name=\"KEY $newID.01.01\">$key
</Key>
<!-- end $newID.01 -->

<Value ID=\"$newID.02\" name=\"VALUE $newID.01.02\">$value
</Value>
<!-- end $newID.02 -->
</Item>
<!-- end $newID -->" > /tmp/insXmluxe-toInject
