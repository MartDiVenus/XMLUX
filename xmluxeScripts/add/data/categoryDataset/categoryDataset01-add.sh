...
if [ -f /tmp/xmluxe-optionName.lmx ]; then
	...
	## siccome per i category dataset01 non si esprime il 'title',
# devo 'comunicare' l'esistenza dell'item ora con un touch; mentre per
# e.g. category dataset02 invece, il seguent file è scritto da java ... itemFileWriter7.java

touch /tmp/xmluxe-itemElement
...
##### per i category dataset 02 non esiste il 'title' per gli Item
### appendo a /tmp/pre
leggoElement="Item"
...
## oppure
#			java /usr/local/lib/xmlux/java/xmluxe/add/data/categoryDataset/valueFileWriter7.java
			fi
