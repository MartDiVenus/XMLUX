...
mkdir $percorsoIsolato/$nomeFile-xmlux
		...
		cat /usr/local/lib/xmlux/documentClasses/brief/brief-book/css2/brief-book.lmx > $percorsoIsolato/$nomeFile-xmlux/$nomeFile.lmx
		...
		vim -c ":%s/brief-book.css/$nomeFile.css/g"	$percorsoIsolato/$nomeFile-xmlux/$nomeFile.lmx -c :w -c :q

                vim -c ":%s/brief-book.dtd/$nomeFile.dtd/g"	$percorsoIsolato/$nomeFile-xmlux/$nomeFile.lmx -c :w -c :q
...
mkdir $nomeFile-xmlux
		...
		cat /usr/local/lib/xmlux/documentClasses/brief/brief-book/css2/brief-book.lmx > $nomeFile-xmlux/$nomeFile.lmx
		...
		vim -c ":%s/brief-book.css/$nomeFile.css/g" $nomeFile-xmlux/$nomeFile.lmx -c :w -c :q

                vim -c ":%s/brief-book.dtd/$nomeFile.dtd/g" $nomeFile-xmlux/$nomeFile.lmx -c :w -c :q
