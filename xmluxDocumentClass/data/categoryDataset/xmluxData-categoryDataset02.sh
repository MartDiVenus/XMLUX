...
mkdir $percorsoIsolato/$nomeFile-xmlux
		...
		cat /usr/local/lib/xmlux/documentClasses/data/categoryDataset/css2/categoryDataset02.lmx > $percorsoIsolato/$nomeFile-xmlux/$nomeFile.lmx
		...
		vim -c ":%s/categoryDataset02.css/$nomeFile.css/g"	$percorsoIsolato/$nomeFile-xmlux/$nomeFile.lmx -c :w -c :q

                vim -c ":%s/categoryDataset02.dtd/$nomeFile.dtd/g"	$percorsoIsolato/$nomeFile-xmlux/$nomeFile.lmx -c :w -c :q
...
mkdir $nomeFile-xmlux
		...
		cat /usr/local/lib/xmlux/documentClasses/data/categoryDataset/css2/categoryDataset02.lmx > $nomeFile-xmlux/$nomeFile.lmx
		...
		vim -c ":%s/categoryDataset02.css/$nomeFile.css/g" $nomeFile-xmlux/$nomeFile.lmx -c :w -c :q

                vim -c ":%s/categoryDataset02.dtd/$nomeFile.dtd/g" $nomeFile-xmlux/$nomeFile.lmx -c :w -c :q
