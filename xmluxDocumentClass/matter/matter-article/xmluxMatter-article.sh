...
mkdir $percorsoIsolato/$nomeFile-xmlux
		...
		cat /usr/local/lib/xmlux/documentClasses/matter/matter-article/css2/matter-article.lmx > $percorsoIsolato/$nomeFile-xmlux/$nomeFile.lmx
		...
		vim -c ":%s/matter-article.css/$nomeFile.css/g"	$percorsoIsolato/$nomeFile-xmlux/$nomeFile.lmx -c :w -c :q

                vim -c ":%s/matter-article.dtd/$nomeFile.dtd/g"	$percorsoIsolato/$nomeFile-xmlux/$nomeFile.lmx -c :w -c :q
...
mkdir $nomeFile-xmlux
		...
		cat /usr/local/lib/xmlux/documentClasses/matter/matter-article/css2/matter-article.lmx > $nomeFile-xmlux/$nomeFile.lmx
		...
		vim -c ":%s/matter-article.css/$nomeFile.css/g" $nomeFile-xmlux/$nomeFile.lmx -c :w -c :q

                vim -c ":%s/matter-article.dtd/$nomeFile.dtd/g" $nomeFile-xmlux/$nomeFile.lmx -c :w -c :q
