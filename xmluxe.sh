...
echo "Only for septem gradus data (data-seven)"
echo "Insert gradusI ID, cloning the structure made by xtextus' -st option. 			--ins='ID' -st"
echo ""
echo ""
echo "		Only for:"
...
echo ""
echo ""
echo "Insert an ID family level, following the structure assigned
in *.str file, and sort ascending through name attribute				--ins-a='ID' -st"
echo "that you'll supply interactively."
echo ""
echo "Insert an ID family level, following the structure assigned
in *.str file, and sort ascending through title						--ins-at='ID' -st"
echo "that you'll supply interactively."
echo ""
echo "Insert an ID family level, following the structure assigned
in *.str file, and sort descending through name attribute				--ins-d='ID' -st"
echo "that you'll supply interactively."
echo ""
echo "Insert an ID family level, following the structure assigned
in *.str file, and sort descending through title					--ins-dt='ID' -st"
echo "that you'll supply interactively."
echo ""
echo ""
...
echo ""
echo "Only for septem gradus data (data-seven)"
echo "Add gradusI ID, cloning the structure made by xtextus' -st option. 	--add='ID' -st"
echo ""
echo ""
echo ""
echo "Write title and content of the ID element to add.  			--add='ID' -w"
echo ""
echo ""
echo "Write name attribute content of the ID element to add.  		--add='ID' -name"
echo ""
echo "Only for category dataset and pie dataset document classes:"
echo "Add title of the ID Key element to add, or sort ID Key element.		--add='ID' -k"
...
echo ""
echo ""
echo "Delete multiple empty lines.							-delEmpty
Avoid to use this option in documents having 
'xml:space=\"preserve\"'
because it would ruin the formatting."
echo ""
echo ""
echo "Add one empty line after an element closing					-addEmpty
<!-- end ... -->"
echo ""
echo ""
echo "Execute -delEmpty and -addEmpty options together in one instance		-format"
echo ""
echo ""
echo ""
echo ""
