...
margin-left: 270px; margin-right: 300px; text-align: left; padding-top: 2ex; padding-bottom: 5ex; border-left: 2px solid rgb(25, 25, 50); border-right: 2px solid rgb(25, 25, 50); border-top: 2px solid rgb(25, 25, 50); border-bottom: 2px solid rgb(25, 25, 50); width: 11.18in }" >> $targetFile.css
...
$leggoItem { display: block; 
font-size: 23pt; font-weight: bold; font-family: Roboto, \"Roboto\", sans-serif; 
margin-left: 270px; margin-right: 300px; text-align: left; padding-top: 3ex; padding-bottom: 3ex; border-bottom: 2px solid rgb(25, 25, 50); width: 11.18in }" >> $targetFile.css
...
#padding-top: 4ex; padding-bottom: 4ex; padding-left: 2ex; padding-right: 2ex; 
...
#		else ## del margin=true
		...
		echo "/** 'Item' = $leggoItem $leggoID*/
$leggoItem { display: block; font-size: 17pt; font-weight: bold; font-family: Roboto, \"Roboto\", sans-serif; 
padding-top: 2ex; padding-bottom: 1ex; padding-left: 2ex; padding-right: 2ex }" >> $targetFile.css
