...
################ INIZIO ROOT = TITLE = TITULUS = PIE-DATASET CSS, DTD
...
$leggoItem { display: block; font-size: 23pt; font-weight: bold; font-family: Roboto, \"Roboto\", sans-serif; 
margin-left: 300px; margin-right: 300px; padding-top: 3ex; padding-bottom: 3ex; padding-left: 2ex; padding-right: 2ex; border-bottom: 2px solid rgb(25, 25, 50);
border-top: 2px solid rgb(25, 25, 50);  border-left: 2px solid rgb(25, 25, 50); border-right: 2px solid rgb(25, 25, 50) }" >> $targetFile.css

		else ## del margin=true

		echo "/** 'Item' = $leggoItem $leggoID*/
$leggoItem { display: block; font-size: 23pt; font-weight: bold; font-family: Roboto, \"Roboto\", sans-serif;
margin-left: 300px; margin-right: 300px; padding-top: 3ex; padding-bottom: 3ex; padding-left: 2ex; padding-right: 2ex; border-bottom: 2px solid rgb(25, 25, 50) }" >> $targetFile.css
...
echo "/* Key or Value $leggoItem $leggoID */
$leggoItem { display: block; font-size: 95%; font-weight: bold; font-family: Roboto, \"Roboto\", sans-serif;
padding-top: 2ex; padding-bottom: 2ex }" >> $targetFile.css
...
do
	...
	## a differenza della sinossi e di ITEM, posso avere più capitoli in un file *.lmx.	
...
## e.g. tale elemento ITEM può contenere uno o più sotto-elementi <Sub-key or Sub-value>, dovrei scrivere:
## Item+
##
## <*> per esprimere <zero or more>
## e.g. tale elemento ITEM può contenere zero o più sotto-elementi <Item>, dovrei scrivere:
## Item*
##
...
## <+> per esprimere <one or more> 
## e.g. tale elemento Item può contenere uno o più sotto-elementi <Sub-key or Sub-value>, dovrei scrivere:
## Sub-key or Sub-value+
##
## <*> per esprimere <zero or more>
## e.g. tale elemento Item può contenere zero o più sotto-elementi <Sub-key or Sub-value>, dovrei scrivere:
## Sub-key or Sub-value*
##
echo "<!-- All that is under \"Item\" = $leggoItem = $leggoID -->
...
## dopo <p> dagli elementi che vanno daa Sub-key or Sub-value a gradusVII
