...
font-family: Roboto, "Roboto", sans-serif }" >> $targetFile.css
...
#font-family: Roboto, \"Roboto\", sans-serif; margin-left: 270px; margin-right: 300px; text-align: left; 
...
#		then
		...
		echo "/* 'gradusI' = $leggoItem  $leggoID */
$leggoItem { display: block; 
font-size: 23pt; font-weight: bold; font-family: Roboto, \"Roboto\", sans-serif; 
margin-left: 270px; margin-right: 300px; text-align: left; padding-top: 3ex }" >> $targetFile.css
...
do
	...
	if test $leggoBytesMarginTrue -gt 0
		...
		echo "/** 'gradusII' = $leggoItem $leggoID*/
$leggoItem { display: block; font-size: 20pt; font-weight: bold; font-family: Roboto, \"Roboto\", sans-serif; 
...
################ INIZIO gradusIII -> CSS

leggoIdRoot="$(cat /tmp/xmluxc-idRoot)"

grep "ID=\"$leggoIdRoot" /tmp/xmluxc-css05 > /tmp/xmlux-gradusIIIAnd

rm -fr /tmp/xmluxc-css05Split

mkdir /tmp/xmluxc-css05Split

split -l1 /tmp/xmlux-gradusIIIAnd  /tmp/xmluxc-css05Split/
...
echo "/* gradusIII $leggoItem $leggoID */
$leggoItem { display: block; font-size: 85%; font-weight: bold; font-family: Roboto, \"Roboto\", sans-serif;
padding-top: 2ex; padding-bottom: 1ex; padding-bottom: 1ex; padding-left: 2ex; padding-right: 2ex; border-bottom: 2px solid rgb(25, 25, 50); border-top: 2px solid rgb(25, 25, 50); width: 10.65in }" >> $targetFile.css
...
echo "/* gradusIV $leggoItem $leggoID */
$leggoItem { display: block; font-size: 90%; font-weight: bold; font-family: Roboto, \"Roboto\", sans-serif;
padding-left: 2ex; padding-right: 2ex; padding-top: 1ex; padding-bottom: 1ex }" >> $targetFile.css
...
echo "/* gradusV $leggoItem $leggoID */
$leggoItem {display: block; font-size: 90%; font-weight: bold; font-family: Roboto, \"Roboto\", sans-serif;
padding-left: 2ex; padding-right: 2ex; padding-top: 1ex; padding-bottom: 1ex }" >> $targetFile.css
...
echo "/* gradusVI $leggoItem $leggoID */
$leggoItem {display: block; font-size: 90%; font-weight: bold; font-family: Roboto, \"Roboto\", sans-serif;
padding-left: 2ex; padding-right: 2ex; padding-top: 1ex; padding-bottom: 1ex }" >> $targetFile.css
...
echo "/* gradusVII $leggoItem $leggoID */
$leggoItem {display: block; font-size: 90%; font-weight: bold; font-family: Roboto, \"Roboto\", sans-serif;
padding-left: 2ex; padding-right: 2ex; padding-top: 1ex; padding-bottom: 1ex }" >> $targetFile.css
...
################ INIZIO  gradusI  DTD, LOG, XML SCHEMA, XSL
if [ ! -f /tmp/xmluxc-escapeDtd ]; then
...
do
	...
	## a differenza della sinossi e di gradusI, posso avere più capitoli in un file *.lmx.	
...
## e.g. tale elemento gradusI può contenere uno o più sotto-elementi <gradusIII>, dovrei scrivere:
## gradusII+
##
## <*> per esprimere <zero or more>
## e.g. tale elemento gradusI può contenere zero o più sotto-elementi <gradusII>, dovrei scrivere:
## gradusII*
##
echo "<!-- All that is under \"gradusI\" = $leggoItem = $leggoID -->
<!ELEMENT $leggoItem ($leggoPartElements)>
<!ATTLIST $leggoItem ID CDATA \"$leggoID\">" > /tmp/xmluxc-preDtd

else

echo "<!-- All that is in \"gradusI\" = $leggoItem = $leggoID -->
<!ELEMENT $leggoItem (#PCDATA)>
<!ATTLIST $leggoItem ID CDATA \"$leggoID\">" > /tmp/xmluxc-preDtd
...
################ FINE gradusI CSS, DTD, LOG, XML SCHEMA, XSLT


############## INIZIO gradusIIS LOG, DTD (b), XSLT, XML SCHEMA
if [ ! -f /tmp/xmluxc-escapeDtd ]; then
...
### Se non volessi riportare esattamente tutti i sotto-elementi, potrei usare:
## <+> per esprimere <one or more> 
## e.g. tale elemento gradusII può contenere uno o più sotto-elementi <gradusIII>, dovrei scrivere:
## gradusIII+
##
## <*> per esprimere <zero or more>
## e.g. tale elemento gradusII può contenere zero o più sotto-elementi <gradusIII>, dovrei scrivere:
## gradusIII*
##
echo "<!-- All that is under \"gradusII\" = $leggoItem = $leggoID -->
<!ELEMENT $leggoItem ($leggoPcdataList)>
<!ATTLIST $leggoItem ID CDATA \"$leggoID\">" > /tmp/xmluxc-preDtd

else

echo "<!-- All that is in \"gradusII\" = $leggoItem = $leggoID -->
<!ELEMENT $leggoItem (#PCDATA)>
<!ATTLIST $leggoItem ID CDATA \"$leggoID\">" > /tmp/xmluxc-preDtd
fi
...
################ FINE gradusIIS LOG, DTD (b), XSLT, XML SCHEMA

#### ok 12 ottobre 10:23 fare anche gradusI prima, e poi tutto ciò che viene dopo gradusII

################ INIZIO gradusIII -> DTD, LOGS, XSLT, XML SCHEMA
...
### Se non volessi riportare esattamente tutti i sotto-elementi, potrei usare:
## <+> per esprimere <one or more> 
## e.g. tale elemento gradusIII può contenere uno o più sotto-elementi <gradusIII>, dovrei scrivere:
## gradusIII+
##
## <*> per esprimere <zero or more>
## e.g. tale elemento gradusIII può contenere zero o più sotto-elementi <gradusIII>, dovrei scrivere:
## gradusIII*
##
echo "<!-- All that is under \"gradusIII\" = $leggoItem = $leggoID -->
<!ELEMENT $leggoItem ($leggoPcdataList)>
<!ATTLIST $leggoItem ID CDATA \"$leggoID\">" > /tmp/xmluxc-preDtd

else

echo "<!-- All that is in \"gradusIII\" = $leggoItem = $leggoID -->
<!ELEMENT $leggoItem (#PCDATA)>
<!ATTLIST $leggoItem ID CDATA \"$leggoID\">" > /tmp/xmluxc-preDtd
...
################ FINE gradusIII -> DTD, LOGS, XSLT, XML SCHEMA
...
### Se non volessi riportare esattamente tutti i sotto-elementi, potrei usare:
## <+> per esprimere <one or more> 
## e.g. tale elemento gradusIV può contenere uno o più sotto-elementi <gradusIII>, dovrei scrivere:
## gradusIII+
##
## <*> per esprimere <zero or more>
## e.g. tale elemento gradusIV può contenere zero o più sotto-elementi <gradusIII>, dovrei scrivere:
## gradusIII*
##
echo "<!-- All that is under \"gradusIV\" = $leggoItem = $leggoID -->
<!ELEMENT $leggoItem ($leggoPcdataList)>
<!ATTLIST $leggoItem ID CDATA \"$leggoID\">" > /tmp/xmluxc-preDtd

else

echo "<!-- All that is in \"gradusIV\" = $leggoItem = $leggoID -->
<!ELEMENT $leggoItem (#PCDATA)>
<!ATTLIST $leggoItem ID CDATA \"$leggoID\">" > /tmp/xmluxc-preDtd
...
################ FINE gradusIV -> DTD, LOGS, XSLT, XML SCHEMA

################ INIZIO gradusV -> DTD, LOGS, XSLT, XML SCHEMA
if [ ! -f /tmp/xmluxc-escapeDtd ]; then
...
### Se non volessi riportare esattamente tutti i sotto-elementi, potrei usare:
## <+> per esprimere <one or more> 
## e.g. tale elemento gradusV può contenere uno o più sotto-elementi <gradusIII>, dovrei scrivere:
## gradusIII+
##
## <*> per esprimere <zero or more>
## e.g. tale elemento gradusV può contenere zero o più sotto-elementi <gradusIII>, dovrei scrivere:
## gradusIII*
##
echo "<!-- All that is under \"gradusV\" = $leggoItem = $leggoID -->
<!ELEMENT $leggoItem ($leggoPcdataList)>
<!ATTLIST $leggoItem ID CDATA \"$leggoID\">" > /tmp/xmluxc-preDtd

else

echo "<!-- All that is in \"gradusV\" = $leggoItem = $leggoID -->
<!ELEMENT $leggoItem (#PCDATA)>
<!ATTLIST $leggoItem ID CDATA \"$leggoID\">" > /tmp/xmluxc-preDtd
...
################ FINE gradusV -> DTD, LOGS, XSLT, XML SCHEMA
...
touch /tmp/xmluxc-pcdata
	...
	## questo mi seleziona anche se sono presenti ID di immagini all'interno di tutto il gradusVI
	#cat /tmp/xmluxc-linesDtdElements | grep -o "ID=\"$leggoIdRoot*.*" > /tmp/xmluxc-linesDtd001
	...
	## la gradusVI ha children o meno
	if test $leggoBytesDtd001 -gt 0
...
### Se non volessi riportare esattamente tutti i sotto-elementi, potrei usare:
## <+> per esprimere <one or more> 
## e.g. tale elemento gradusVI può contenere uno o più sotto-elementi <gradusIII>, dovrei scrivere:
## gradusIII+
##
## <*> per esprimere <zero or more>
## e.g. tale elemento gradusVI può contenere zero o più sotto-elementi <gradusIII>, dovrei scrivere:
## gradusIII*
##
echo "<!-- All that is under \"gradusVI\" = $leggoItem = $leggoID -->
<!ELEMENT $leggoItem ($leggoPcdataList)>
<!ATTLIST $leggoItem ID CDATA \"$leggoID\">" > /tmp/xmluxc-preDtd

else

echo "<!-- All that is in \"gradusVI\" = $leggoItem = $leggoID -->
<!ELEMENT $leggoItem (#PCDATA)>
<!ATTLIST $leggoItem ID CDATA \"$leggoID\">" > /tmp/xmluxc-preDtd
...
################ FINE gradusVI -> DTD, LOGS, XSLT, XML SCHEMA

################ INIZIO gradusVII -> DTD, LOGS, XSLT, XML SCHEMA
if [ ! -f /tmp/xmluxc-escapeDtd ]; then
...
### Se non volessi riportare esattamente tutti i sotto-elementi, potrei usare:
## <+> per esprimere <one or more> 
## e.g. tale elemento gradusVII può contenere uno o più sotto-elementi <gradusIII>, dovrei scrivere:
## gradusIII+
##
## <*> per esprimere <zero or more>
## e.g. tale elemento gradusVII può contenere zero o più sotto-elementi <gradusIII>, dovrei scrivere:
## gradusIII*
##
echo "<!-- All that is under \"gradusVII\" = $leggoItem = $leggoID -->
<!ELEMENT $leggoItem ($leggoPcdataList)>
<!ATTLIST $leggoItem ID CDATA \"$leggoID\">" > /tmp/xmluxc-preDtd

else

echo "<!-- All that is in \"gradusVII\" = $leggoItem = $leggoID -->
<!ELEMENT $leggoItem (#PCDATA)>
<!ATTLIST $leggoItem ID CDATA \"$leggoID\">" > /tmp/xmluxc-preDtd
...
################ FINE gradusVII -> DTD, LOGS, XSLT, XML SCHEMA

################ PCDATA in *.css
echo "/* gradusVI ENV */
p { display: block; font-size: 20pt; font-weight: normal; font-style: normal;
font-family: Roboto, \"Roboto\", sans-serif; white-space: pre; line-break: loose }
pg { display: block; font-size: 20pt; font-weight: normal; font-style: normal;
font-family: Roboto, \"Roboto\", sans-serif; width: 1050px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word }
center { display: block; font-size: 20pt; font-weight: normal; font-family: Roboto, \"Roboto\", sans-serif; text-align: center }
/* FONTS */
/** style **/
it { font-size: 20pt; font-weight: normal; font-style: italic; font-family: Roboto, \"Roboto\", sans-serif; white-space: pre }
sl { font-size: 20pt; font-weight: normal; font-style: oblique; font-family: Roboto, \"Roboto\", sans-serif; white-space: pre }
/** weight, weight/style **/
bf { font-size: 20pt; font-weight: bold; font-family: Roboto, \"Roboto\", sans-serif; white-space: pre }
em { font-size: 20pt; font-style: oblique; font-weight: bold; font-family: Roboto, \"Roboto\", sans-serif; white-space: pre }
/** variant **/
scaps { font-size: 20pt; font-weight: normal; font-style: normal; font-variant: small-caps; font-family: Roboto, \"Roboto\", sans-serif; white-space: pre }
/* DECORATION */
under { font-size: 20pt; font-weight: normal; font-family: Roboto, \"Roboto\", sans-serif; white-space: pre; text-decoration: underline }
lthr { font-size: 20pt; font-weight: normal; font-family: Roboto, \"Roboto\", sans-serif; white-space: pre; text-decoration: line-through }
/* PATH, URL ENV */
...
/* SIZE ENV */
large  { font-size: 25pt; font-weight: normal; font-family: Roboto, \"Roboto\", sans-serif }
Large  { font-size: 28pt; font-weight: normal; font-family: Roboto, \"Roboto\", sans-serif }
small  { font-size: 15pt; font-weight: normal; font-family: Roboto, \"Roboto\", sans-serif }
tiny { font-size: 12pt; font-weight: normal; font-family: Roboto, \"Roboto\", sans-serif }" >> $targetFile.css
...
## dopo <p> dagli elementi che vanno daa gradusIII a gradusVII
