...
font-family: Times, "Times New Roman", serif }" >> $targetFile.css
...
font-family: Times, \"Times New Roman\", serif; margin-left: 270px; margin-right: 300px; text-align: left; 
...
$leggoItem { counter-increment: section-num }
$leggoItem:before { content: counter(section-num) \". \" }
$leggoItem { display: block; 
font-size: 33pt; font-weight: bold; font-family: Times, \"Times New Roman\", serif; 
...
$leggoItem { counter-increment: subsection-num }
$leggoItem:before { content: counter(section-num) \".\" counter(subsection-num) \" \" }
$leggoItem { display: block; font-size: 33pt; font-weight: bold; font-family: Times, \"Times New Roman\", serif; 
...
grep "ID=\"$leggoIdRoot" /tmp/xmluxc-css05 > /tmp/xmlux-subsubsectionAnd

rm -fr /tmp/xmluxc-css05Split

mkdir /tmp/xmluxc-css05Split

split -l1 /tmp/xmlux-subsubsectionAnd  /tmp/xmluxc-css05Split/
...
$leggoItem { counter-increment: subsubsection-num}
$leggoItem:before { content: counter(section-num) \".\" counter(subsection-num) \".\" counter(subsubsection-num) \" \" }
$leggoItem { display: block; font-size: 95%; font-weight: bold; font-family: Times, \"Times New Roman\", serif;
...
$leggoItem { counter-increment: paragraph-num }
$leggoItem:before { content: counter(section-num) \".\" counter(subsection-num) \".\" counter(subsubsection-num) \".\" counter(paragraph-num) \" \" }
$leggoItem { display: block; font-size: 90%; font-weight: bold; font-family: Times, \"Times New Roman\", serif;
...
$leggoItem {counter-increment: subparagraph-num}
$leggoItem:before {content: counter(section-num) \".\" counter(subsection-num) \".\" counter(subsubsection-num) \".\" counter(paragraph-num) \".\" counter(subparagraph-num) \" \" }
$leggoItem {display: block; font-size: 90%; font-weight: bold; font-family: Times, \"Times New Roman\", serif;
padding-top: 1ex; padding-bottom: 1ex }" >> $targetFile.css
...
echo "/* saxum $leggoItem $leggoID */
$leggoItem {counter-increment: saxum-num}
$leggoItem:before {content: counter(section-num) \".\" counter(subsection-num) \".\" counter(subsubsection-num) \".\" counter(paragraph-num) \".\" counter(subparagraph-num) \".\" 
counter(saxum-num) \" \" }
$leggoItem {display: block; font-size: 90%; font-weight: bold; font-family: Times, \"Times New Roman\", serif;
padding-top: 1ex; padding-bottom: 1ex }" >> $targetFile.css
...
echo "/* subsaxum $leggoItem $leggoID */
$leggoItem {counter-increment: subsaxum-num}
$leggoItem:before {content: counter(section-num) \".\" counter(subsection-num) \".\" counter(subsubsection-num) \".\" counter(paragraph-num) \".\" counter(subparagraph-num) \".\" counter(saxum-num) \".\" counter(subsaxum-num) \" \" }
$leggoItem {display: block; font-size: 90%; font-weight: bold; font-family: Times, \"Times New Roman\", serif;
padding-top: 1ex; padding-bottom: 1ex }" >> $targetFile.css
...
do
	...
	## a differenza della sinossi e di section, posso avere più capitoli in un file *.lmx.	
...
## e.g. tale elemento section può contenere uno o più sotto-elementi <subsubsection>, dovrei scrivere:
## subsection+
##
## <*> per esprimere <zero or more>
## e.g. tale elemento section può contenere zero o più sotto-elementi <subsection>, dovrei scrivere:
## subsection*
##
...
### Se non volessi riportare esattamente tutti i sotto-elementi, potrei usare:
## <+> per esprimere <one or more> 
## e.g. tale elemento subsection può contenere uno o più sotto-elementi <subsubsection>, dovrei scrivere:
## subsubsection+
##
## <*> per esprimere <zero or more>
## e.g. tale elemento subsection può contenere zero o più sotto-elementi <subsubsection>, dovrei scrivere:
## subsubsection*
##
...
### Se non volessi riportare esattamente tutti i sotto-elementi, potrei usare:
## <+> per esprimere <one or more> 
## e.g. tale elemento subsubsection può contenere uno o più sotto-elementi <subsubsection>, dovrei scrivere:
## subsubsection+
##
## <*> per esprimere <zero or more>
## e.g. tale elemento subsubsection può contenere zero o più sotto-elementi <subsubsection>, dovrei scrivere:
## subsubsection*
##
...
### Se non volessi riportare esattamente tutti i sotto-elementi, potrei usare:
## <+> per esprimere <one or more> 
## e.g. tale elemento paragraph può contenere uno o più sotto-elementi <subsubsection>, dovrei scrivere:
## subsubsection+
##
## <*> per esprimere <zero or more>
## e.g. tale elemento paragraph può contenere zero o più sotto-elementi <subsubsection>, dovrei scrivere:
## subsubsection*
##
...
### Se non volessi riportare esattamente tutti i sotto-elementi, potrei usare:
## <+> per esprimere <one or more> 
## e.g. tale elemento subparagraph può contenere uno o più sotto-elementi <subsubsection>, dovrei scrivere:
## subsubsection+
##
## <*> per esprimere <zero or more>
## e.g. tale elemento subparagraph può contenere zero o più sotto-elementi <subsubsection>, dovrei scrivere:
## subsubsection*
##
...
touch /tmp/xmluxc-pcdata
	...
	## questo mi seleziona anche se sono presenti ID di immagini all'interno di tutto il saxum
	#cat /tmp/xmluxc-linesDtdElements | grep -o "ID=\"$leggoIdRoot*.*" > /tmp/xmluxc-linesDtd001
...
### Se non volessi riportare esattamente tutti i sotto-elementi, potrei usare:
## <+> per esprimere <one or more> 
## e.g. tale elemento saxum può contenere uno o più sotto-elementi <subsubsection>, dovrei scrivere:
## subsubsection+
##
## <*> per esprimere <zero or more>
## e.g. tale elemento saxum può contenere zero o più sotto-elementi <subsubsection>, dovrei scrivere:
## subsubsection*
##
echo "<!-- All that is under \"saxum\" = $leggoItem = $leggoID -->
<!ELEMENT $leggoItem ($leggoPcdataList)>
<!ATTLIST $leggoItem ID CDATA \"$leggoID\">" > /tmp/xmluxc-preDtd

else

echo "<!-- All that is in \"saxum\" = $leggoItem = $leggoID -->
<!ELEMENT $leggoItem (#PCDATA)>
<!ATTLIST $leggoItem ID CDATA \"$leggoID\">" > /tmp/xmluxc-preDtd
...
### Se non volessi riportare esattamente tutti i sotto-elementi, potrei usare:
## <+> per esprimere <one or more> 
## e.g. tale elemento subsaxum può contenere uno o più sotto-elementi <subsubsection>, dovrei scrivere:
## subsubsection+
##
## <*> per esprimere <zero or more>
## e.g. tale elemento subsaxum può contenere zero o più sotto-elementi <subsubsection>, dovrei scrivere:
## subsubsection*
##
echo "<!-- All that is under \"subsaxum\" = $leggoItem = $leggoID -->
<!ELEMENT $leggoItem ($leggoPcdataList)>
<!ATTLIST $leggoItem ID CDATA \"$leggoID\">" > /tmp/xmluxc-preDtd

else

echo "<!-- All that is in \"subsaxum\" = $leggoItem = $leggoID -->
<!ELEMENT $leggoItem (#PCDATA)>
<!ATTLIST $leggoItem ID CDATA \"$leggoID\">" > /tmp/xmluxc-preDtd
...
font-family: Times, \"Times New Roman\", serif; white-space: pre; line-break: loose }
pg { display: block; font-size: 20pt; font-weight: normal; font-style: normal;
font-family: Times, \"Times New Roman\", serif; width: 1050px; overflow-wrap: break-word; word-wrap: break-word; word-break: break-word }
center { display: block; font-size: 20pt; font-weight: normal; font-family: Times, \"Times New Roman\", serif; text-align: center }
/* FONTS */
/** style **/
it { font-size: 20pt; font-weight: normal; font-style: italic; font-family: Times, \"Times New Roman\", serif; white-space: pre }
sl { font-size: 20pt; font-weight: normal; font-style: oblique; font-family: Times, \"Times New Roman\", serif; white-space: pre }
/** weight, weight/style **/
bf { font-size: 20pt; font-weight: bold; font-family: Times, \"Times New Roman\", serif; white-space: pre }
em { font-size: 20pt; font-style: oblique; font-weight: bold; font-family: Times, \"Times New Roman\", serif; white-space: pre }
/** variant **/
scaps { font-size: 20pt; font-weight: normal; font-style: normal; font-variant: small-caps; font-family: Times, \"Times New Roman\", serif; white-space: pre }
/* DECORATION */
under { font-size: 20pt; font-weight: normal; font-family: Times, \"Times New Roman\", serif; white-space: pre; text-decoration: underline }
lthr { font-size: 20pt; font-weight: normal; font-family: Times, \"Times New Roman\", serif; white-space: pre; text-decoration: line-through }
/* PATH, URL ENV */
...
/* SIZE ENV */
large  { font-size: 25pt; font-weight: normal; font-family: Times, \"Times New Roman\", serif }
Large  { font-size: 28pt; font-weight: normal; font-family: Times, \"Times New Roman\", serif }
small  { font-size: 15pt; font-weight: normal; font-family: Times, \"Times New Roman\", serif }
tiny { font-size: 12pt; font-weight: normal; font-family: Times, \"Times New Roman\", serif }" >> $targetFile.css
...
## dopo <p> dagli elementi che vanno daa subsubsection a subsaxum
