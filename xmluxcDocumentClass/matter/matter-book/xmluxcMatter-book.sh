...
$leggoItem { counter-increment: part-num }
$leggoItem:before { content: counter(part-num) \". \" }
...
$leggoItem { counter-increment: chapter-num }
$leggoItem:before { content: counter(part-num) \".\" counter(chapter-num) \" \" }
...
$leggoItem:before { content: counter(part-num) \".\" counter(chapter-num) \".\" counter(section-num) \" \" }
...
$leggoItem:before { content: counter(part-num) \".\" counter(chapter-num) \".\" counter(section-num) \".\" counter(subsection-num) \" \" }
...
$leggoItem:before {content: counter(part-num) \".\" counter(chapter-num) \".\" counter(section-num) \".\" counter(subsection-num) \".\" counter(subsubsection-num) \" \" }
$leggoItem {display: block; font-size: 90%; font-weight: bold; font-family: Times, \"Times New Roman\", serif;
padding-top: 1ex; padding-bottom: 1ex }" >> $targetFile.css
...
$leggoItem:before {content: counter(part-num) \".\" counter(chapter-num) \".\" counter(section-num) \".\" counter(subsection-num) \".\" counter(subsubsection-num) \".\" counter(paragraph-num) \".\" counter(subparagraph-num) \" \" }
$leggoItem {display: block; font-size: 90%; font-weight: bold; font-family: Times, \"Times New Roman\", serif;
padding-top: 1ex; padding-bottom: 1ex }" >> $targetFile.css
